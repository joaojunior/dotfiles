...
let g:vim_bootstrap_langs = "c,elixir,elm,erlang,go,haskell,html,javascript,python,ruby,rust,scala"
...
" grep.vim
nnoremap <silent> <leader>gp :Rgrep<CR>
...
augroup vimrc-ruby
  ...
  autocmd FileType ruby set tabstop=2|set shiftwidth=2|set expandtab softtabstop=2 colorcolumn=100
augroup END
